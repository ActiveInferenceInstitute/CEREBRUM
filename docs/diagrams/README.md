...
This directory contains Mermaid diagram source files and related assets for CEREBRUM documentation.
...
Diagrams are rendered using `@mermaid-js/mermaid-cli`. See `config.yaml` for rendering configuration.
